...
public class CoordinatorBasicAuthenticatorMetadataStorageUpdaterTest {
	...
	public void setUp() {
		...
		BasicAuthenticatorCacheNotifier Notifier = Mockito.mock(BasicAuthenticatorCacheNotifier.class);
		...
		updater = new CoordinatorBasicAuthenticatorMetadataStorageUpdater(
				...
				connector, tablesConfig, new BasicAuthCommonCacheConfig(null, null, null, null), objectMapper, Notifier,
				null);
