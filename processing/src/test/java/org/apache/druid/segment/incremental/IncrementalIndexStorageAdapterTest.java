...
public class IncrementalIndexStorageAdapterTest extends InitializedNullHandlingTest {
	...
	private static class DictionaryRaceTestFilter implements Filter {
		...
		public ValueMatcher makeMatcher(ColumnSelectorFactory factory) {
			return Filters.makeValueMatcher(factory, "billy", mockDruidPredicateFactory());
		}
		...
		private DruidPredicateFactory mockDruidPredicateFactory() {
			DruidPredicateFactory res = Mockito.mock(DruidPredicateFactory.class);
			Mockito.when(res.makeStringPredicate()).thenAnswer(invo -> {
				try {
					index.add(new MapBasedInputRow(timestamp, Collections.singletonList("billy"),
			...
			Mockito.when(res.makeLongPredicate()).thenThrow(new UnsupportedOperationException());
			Mockito.when(res.makeFloatPredicate()).thenThrow(new UnsupportedOperationException());
			Mockito.when(res.makeDoublePredicate()).thenThrow(new UnsupportedOperationException());
			return res;
		}
