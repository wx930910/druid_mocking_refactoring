...
public class NumericNullColumnSelectorTestMock {
	...
	private final NoFilterOffsetThatCanBeMangledToTestOverlapping anotherVectorOffset = new NoFilterOffsetThatCanBeMangledToTestOverlapping(
			vectorSize, 0, numRows);
	...
	private static void assertOffsetCanReset(BaseNullableColumnValueSelector selector, ImmutableBitmap bitmap,
	...
	private static void assertVectorOffsetCanReset(VectorValueSelector selector, ImmutableBitmap bitmap,
	...
	public static void assertVectorChillWhenOffsetsOverlap(VectorValueSelector selector, ImmutableBitmap bitmap,
		...
		Assert.assertTrue(encounteredNull);
		// this can't currently happen, but we want to protect selectors in case
		// offsets ever try to overlap
