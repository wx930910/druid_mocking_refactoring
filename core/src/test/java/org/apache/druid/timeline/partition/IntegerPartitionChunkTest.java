...
public class IntegerPartitionChunkTest {
	private static IntegerPartitionChunk<Overshadowable> make(Integer start, Integer end, int chunkNumber, int obj) {
	...
	public void testAbuts() {
		IntegerPartitionChunk<Overshadowable> lhs = make(null, 10, 0, 1);
