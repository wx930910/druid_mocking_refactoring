...
public class SegmentManagerTestMock {
	private static final SegmentLoader SEGMENT_LOADER = new SegmentLoader() {
		...
		public Segment getSegment(final DataSegment segment, boolean lazy) {
			// String version = MapUtils.getString(segment.getLoadSpec(),
			// "version");
			// final Interval interval = (Interval)
			// segment.getLoadSpec().get("interval");
			// Segment sft = Mockito.mock(Segment.class);
			// Mockito.when(stf.)
